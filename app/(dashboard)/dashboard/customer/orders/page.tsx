...
import { MoreHorizontal, ChevronLeft, ChevronRight, ShoppingBag } from "lucide-react";
...
export default function CustomerOrdersPage() {
  ...
  const { data, isLoading, isError } = useCustomerOrders(user?.id ?? "", {
          ...
          <Table>
            ...
            <TableBody>
              {isLoading ? (
                ...
                <TableRow>
                  <TableCell colSpan={6} className="text-center text-destructive">Failed to load orders.</TableCell>
                </TableRow>
              ) : orders.length === 0 ? (
                <TableRow>
                  <TableCell colSpan={6}>
